      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Doanh Thu <span>| Tháng 1</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Khách hàng <span>| Năm 2024</span></h5>
        ...
        <div class="col-lg-4">
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Hi! <a href="#" class="fw-bold text-dark">Tôi sẽ giải thích nhiệm vụ của mình.</a> Cảm ơn!
                  </div>
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Kho thiếu sản phẩm.<a href="#" class="fw-bold text-dark">Hãy nhập về.</a> Cảm ơn!
                  </div>
                </div><!-- End activity item-->
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Báo cáo ngân sách <span>| Tháng 1</span></h5>
