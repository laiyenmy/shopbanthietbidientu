            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="/ShopOnline/login" method="post">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Bạn chưa có tài khoản? <a href="/ShopOnline/views/admin/register.jsp">Tạo tài khoản</a></p>
                    </div>
                  </form>
					<c:if test="${requestScope.registerSuccess != null}">
                      	<p class="alert alert-success">${requestScope.registerSuccess}</p>
                    </c:if>
                </div>
              </div>
            </div>
